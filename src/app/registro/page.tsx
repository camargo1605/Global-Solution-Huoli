...
export default function RegistroPage() {
    ...
    const fields = [
        ...
        { label: "CPF", name: "cpf", type: "text", placeholder: "Digite seu CPF (sem pontuação)", required: true, pattern: "[0-9]{11}", title: "Digite um CPF válido, por exemplo: 12345678901" },
        ...
        { label: "CEP", name: "cep", type: "text", placeholder: "Digite seu CEP (sem pontuação)", required: true, pattern: "[0-9]{8}", title: "Digite um CEP válido, por exemplo: 12345678" },
