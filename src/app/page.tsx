...
export default function Home() {
  return (
    <div className="h-screen bg-gradient-to-tr from-blue-700 to-teal-700 flex items-center justify-center px-8">
      <div className="max-w-5xl flex flex-wrap items-center justify-between gap-8">
        <div className="flex-1">
          ...
          <Link href={'/pages/registro'} className="bg-white text-teal-700 font-semibold py-3 px-6 rounded-md hover:bg-gray-200 transition duration-300">
            COMEÇE AGORA
          </Link>
        </div>
